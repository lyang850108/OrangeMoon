...
public class ArticleFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        mArticleAdapter = new ArticleListAdapter(this, mActivity.getLayoutInflater());
        mRecyclerView.setAdapter(mArticleAdapter);
        mArticleAdapter.setOnItemClickListener(new ArticleListAdapter.OnItemClickListener() {
            @Override
