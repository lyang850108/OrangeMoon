package com.orangemoo.com.beta.widget;
...
import com.orangemoo.com.beta.util.Utils;
...
//        }
    ...
    private void hide(final View view) {
        ViewPropertyAnimator animator = view.animate().translationY(view.getHeight()).setInterpolator(INTERPOLATOR)
                .setDuration(Utils.SWIPE_BEHAVIOR_ANIMATION_TIME);
